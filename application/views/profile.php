...
<?php if(isset($user_data)){?>
	...
	<div class="form-group">
			<div class="row">
				...
				<div class="col-md-3">
				<input class="form-control" type="text" name="study_level" value='<?php echo $user_data->study_level?>'  readonly>
				</div>
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-3">
				<input class="form-control" type="text" name="university" value='<?php echo $user_data->university ?>'  readonly>
				</div>
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-3">
				<input class="form-control" type="text" name="major" value="<?php echo $user_data->major ?>"  readonly>
				</div>
				
			</div>
		</div>
		<div>
		<a href="<?php echo site_url('profile/update_profile/'); ?>">Update Profile</a>
		</div>
